...
A Rust SDK for Huawei Cloud Object Storage Service (OBS).
...
- 🌊 **Streaming I/O** - Upload and download large objects without buffering them fully in memory
...
For large files, use streaming download to consume chunks as they arrive:
...
| `client.get_object()` | Download an object into memory |
| `client.get_object().send_streaming()` | Stream an object download |
...
# Run OBS integration tests after setting environment variables
