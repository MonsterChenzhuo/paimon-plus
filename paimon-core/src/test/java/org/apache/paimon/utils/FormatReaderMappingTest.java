...
public class FormatReaderMappingTest {
    ...
    @Test
    public void testActualReadTypeAndIdentityMappingAccessors() {
        ...
        Assertions.assertThat(formatReaderMapping.getActualReadRowType()).isEqualTo(actualReadType);
        Assertions.assertThat(formatReaderMapping.hasIdentityIndexMapping()).isTrue();
        Assertions.assertThat(formatReaderMapping.hasNoCastMapping()).isTrue();
    }
}
