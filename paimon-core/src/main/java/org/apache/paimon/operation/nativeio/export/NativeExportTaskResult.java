...
/** Native export task result returned to the engine scheduler. */
public final class NativeExportTaskResult implements Serializable {
    ...
    public NativeExportTaskResult(long rowsOutput, String metricsJson) {
