...
public class KeyValueFileStore extends AbstractFileStore<KeyValue> {
    ...
    public NativeSplitReadContext newNativeSplitReadContext() {
        NativeIOOptions nativeIOOptions = NativeIOOptions.from(options.toConfiguration());
        return new NativeSplitReadContext(
                ...
                options,
                nativeIOOptions,
                options.toConfiguration().get(CoreOptions.NATIVE_IO_INTERNAL_ENGINE),
